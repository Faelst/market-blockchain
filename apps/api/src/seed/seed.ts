...
const REALISTIC_COLLECTIONS = [
  {
    ...
    description:
      "A collection of 10,000 Bored Ape NFTs—unique digital collectibles living on the Ethereum blockchain. Your Bored Ape doubles as your Yacht Club membership card, and grants access to members-only benefits.",
    category: "PFP",
    verified: true,
    featured: true,
    totalSupply: 10000,
  ...
  },
  {
    name: "Art Blocks",
    description:
      "Curated generative art collections where the algorithm is the artist. Each piece is unique and created by code.",
  ...
  },
  {
    name: "World of Women",
    description:
      "A collection of 10,000 NFTs celebrating representation, inclusivity, and equal opportunities for all.",
    category: "PFP",
    verified: true,
    featured: false,
    totalSupply: 10000,
  ...
  },
  {
    name: "CloneX",
    description:
      "Next-gen Avatars For The Metaverse. CloneX is a collection of 20,000 next-gen Avatars, designed by RTFKT.",
    category: "3D",
    verified: true,
    featured: true,
    totalSupply: 20000,
  ...
  },
  {
    name: "Azuki",
    description:
      "A brand for the metaverse. Built by the community. Azuki starts with a collection of 10,000 avatars that give you membership access to The Garden.",
    category: "PFP",
    verified: true,
    featured: true,
    totalSupply: 10000,
  ...
  },
  {
    name: "Cool Cats",
    description:
      "Cool Cats is a collection of 9,999 randomly generated and stylistically curated NFTs that exist on the Ethereum Blockchain.",
    category: "PFP",
    verified: true,
    featured: false,
    totalSupply: 9999,
  ...
  },
  {
    name: "Meebits",
    description:
      "20,000 unique 3D voxel characters, created by a custom generative algorithm, then registered on the Ethereum blockchain.",
    category: "3D",
    verified: true,
    featured: false,
    totalSupply: 20000,
  ...
  },
  {
    name: "Fidenza",
    description:
      "Fidenza is a long-form generative art project created by Tyler Hobbs. It is a series of outputs, each with a unique grid structure driven by an underlying algorithm.",
    category: "Generative Art",
    verified: true,
    featured: true,
    totalSupply: 999,
  ...
  },
  {
    ...
    description:
      "Chromie Squiggle by Snowfro is a generative art project that creates unique, colorful squiggles. Each piece is algorithmically generated.",
    category: "Generative Art",
    verified: true,
    featured: false,
    totalSupply: 9999,
...
const REALISTIC_USERS = [
  {
    name: "Beeple",
    username: "beeple",
    bio: "Digital artist behind 'Everydays'.",
  },
  {
    name: "Pak",
    username: "pak",
    bio: "Anonymous digital artist; creator of 'The Fungible'.",
  },
  {
    name: "XCOPY",
    username: "xcopy",
    bio: "Glitch art exploring tech and mortality.",
  },
  {
    name: "Hackatao",
    username: "hackatao",
    bio: "Italian duo blending symbolism and tech.",
  },
  {
    name: "FEWOCiOUS",
    username: "fewocious",
    bio: "Colorful, emotional works about identity.",
  },
  {
    name: "Tyler Hobbs",
    username: "tylerhobbs",
    bio: "Generative artist; algorithmic aesthetics.",
  },
  {
    name: "Snowfro",
    username: "snowfro",
    bio: "Art Blocks founder; Chromie Squiggle.",
  },
  {
    name: "Matt DesLauriers",
    username: "mattdesl",
    bio: "Creative coder; math and art.",
  },
  {
    name: "Sofia Crespo",
    username: "sofiacrespo",
    bio: "Nature and AI explorations.",
  },
  {
    name: "Refik Anadol",
    username: "refikanadol",
    bio: "Immersive ML-driven installations.",
  },
  {
    name: "Casey Reas",
    username: "caseyreas",
    bio: "Processing co-creator; generative art.",
  },
  { name: "Mario Klingemann", username: "quasimondo", bio: "AI art pioneer." },
  {
    name: "Helena Sarin",
    username: "helenasarin",
    bio: "Neural artworks and sketching.",
  },
  {
    name: "Robbie Barrat",
    username: "robbiebarrat",
    bio: "GANs and creative ML.",
  },
  {
    name: "Anna Ridler",
    username: "annaridler",
    bio: "Data, AI, and narratives.",
  },
];
...
const COLLECTION_THEMES: Record<string, { banner: string; logo: string }> = {
  "bored ape yacht club": {
    banner: "yacht, tropical, palm, luxury",
    logo: "ape, portrait, illustration",
  },
  cryptopunks: {
    banner: "city, neon, cyberpunk, pixel",
    logo: "pixel art face, 8-bit, portrait",
  },
  "art blocks": {
    banner: "generative art, abstract patterns, geometry",
    logo: "abstract geometric, bold colors",
  },
  "world of women": {
    banner: "women, diversity, vibrant colors",
    logo: "female portrait, illustration",
  },
  doodles: {
    banner: "pastel colors, playful, doodles",
    logo: "cartoon face, pastel portrait",
  },
  clonex: {
    banner: "futuristic, 3d render, neon",
    logo: "3d avatar, portrait",
  },
  azuki: {
    banner: "anime, garden, sakura, red",
    logo: "anime portrait, illustration",
  },
  "cool cats": {
    banner: "cats, playful, blue",
    logo: "cat illustration, portrait",
  },
  meebits: { banner: "voxel, 3d, minimal", logo: "voxel face, 3d portrait" },
  "mutant ape yacht club": {
    banner: "mutant, neon, lab",
    logo: "mutant ape, portrait",
  },
  fidenza: {
    banner: "generative art, fidenza style, curves",
    logo: "abstract curves, warm palette",
  },
  "chromie squiggle": {
    banner: "rainbow, gradient, neon",
    logo: "colorful squiggle, minimal",
  },
};
...
function getCollectionMedia(name: string, index: number) {
  ...
  return {
    banner: getMediaUrl(`${name}-banner`, index, "image").replace(
      "/800/800",
      "/1500/500"
    ),
    logo: getMediaUrl(`${name}-logo`, index, "image").replace(
      "/800/800",
      "/400/400"
    ),
  };
...
function generateRealisticAttributes(collection: any, tokenId: number): any[] {
  ...
  const traits =
    TRAIT_CATEGORIES[category as keyof typeof TRAIT_CATEGORIES] ||
    TRAIT_CATEGORIES.PFP;
...
async function main() {
  ...
  for (let i = 0; i < COLLECTIONS; i++) {
    const collectionData =
      REALISTIC_COLLECTIONS[i % REALISTIC_COLLECTIONS.length];
  ...
  for (let i = 0; i < NFTS; i++) {
    ...
    const nft = {
      ...
      videoUrl:
        fileType === "video"
          ? getMediaUrl(collection.name, tokenId, "video")
          : undefined,
      audioUrl:
        fileType === "audio"
          ? getMediaUrl(collection.name, tokenId, "audio")
          : undefined,
      creator: creator._id,
      owner: owner._id,
    ...
    for (const nft of nftDocs) {
      ...
      if (doSale) {
        ...
        const soldAt = new Date(
          mintAt.getTime() + randInt(1, 30) * 24 * 3600 * 1000
        );
        txs.push({
          type: "sale",
          nft: nft._id,
